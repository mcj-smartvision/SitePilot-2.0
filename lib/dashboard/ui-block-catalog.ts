...
export const UI_BLOCK_CATALOG: UiBlockDefinition[] = [
  ...
  { code: 'PM-CHT-02', key: 'pm.chart.zone_progress', kind: 'chart', dashboard: 'project-manager', layer: 'analytical', titleFa: 'وضعیت فعالیت‌های موعد', titleEn: 'Due activity status', descriptionFa: 'میله‌ای انجام/مطابق/عقب/شروع‌نشده', sortOrder: 121, defaultVisible: true },
